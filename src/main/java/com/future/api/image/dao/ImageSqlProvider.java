...
import com.future.api.image.domain.ImageCriteria.Criteria;
import com.future.api.image.domain.ImageCriteria.Criterion;
...
public class ImageSqlProvider {
    ...
    public String countByExample(ImageCriteria example) {
        BEGIN();
        SELECT("count(*)");
        FROM("t_image");
    ...
    public String deleteByExample(ImageCriteria example) {
        BEGIN();
        DELETE_FROM("t_image");
        applyWhere(example, false);
        return SQL();
    ...
    public String selectByExample(ImageCriteria example) {
        BEGIN();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ...
        ImageCriteria example = (ImageCriteria) parameter.get("example");
    ...
    protected void applyWhere(ImageCriteria example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
