...
import com.future.api.role.domain.RoleResourcesCriteria.Criteria;
import com.future.api.role.domain.RoleResourcesCriteria.Criterion;
...
public class RoleResourcesSqlProvider {
    ...
    public String countByExample(RoleResourcesCriteria example) {
        BEGIN();
        SELECT("count(*)");
    ...
    public String deleteByExample(RoleResourcesCriteria example) {
        BEGIN();
    ...
    public String insertSelective(RoleResources record) {
        ...
        if (record.getResourceId() != null) {
            VALUES("resource_id", "#{resourceId,jdbcType=VARCHAR}");
        }
    ...
    public String selectByExample(RoleResourcesCriteria example) {
        BEGIN();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ...
        RoleResourcesCriteria example = (RoleResourcesCriteria) parameter.get("example");
    ...
    public String updateByPrimaryKeySelective(RoleResources record) {
        BEGIN();
        UPDATE("t_role_resources");
    ...
    protected void applyWhere(RoleResourcesCriteria example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
